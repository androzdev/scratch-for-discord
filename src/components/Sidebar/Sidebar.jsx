...
import { faCog, faRobot, faTerminal, faServer } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="bg-gray-900 w-20 border-r-2 border-gray-600">
            ...
            <div>
                ...
                <div className="border-b-2 pb-5 border-gray-400">
                    <Link to="/store">
                        <p className="text-4xl text-white opacity-90 hover:opacity-100 text-center mt-3 cursor-pointer" title="Extensions Store">
